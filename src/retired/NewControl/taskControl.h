...
struct TaskControlMethod {
  boolA lockJoints;
  virtual ~TaskControlMethod() {}
  virtual void calculate(CtrlCmdMsg& ctrlCmdMsg, const CtrlStateMsg& ctrlStateMsg, const CtrlTaskL& tasks, const rai::KinematicWorld& ctrl_config) = 0;
...
struct TaskControlMethodInverseKinematics : TaskControlMethod {
  arr HMetric;
  TaskControlMethodInverseKinematics(const rai::KinematicWorld& ctrl_config);
