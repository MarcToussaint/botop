...
frame (base){ Q:<t(-.01 0 -.04) d(45 0 1 0)> shape:ssBox size:[.08 1.12 .08 .01] color:[.6 .6 .6] }
frame (base){ Q:<t(-.14 0 -.04) d(45 0 1 0)> shape:ssBox size:[.08 1.12 .08 .01] color:[.6 .6 .6] }


#table
frame table(world){ Q:<t(.45 0 .769)> shape:ssBox size:[1.2 2. .018 .005] color:[.4 .3 .2] }
...
frame camera(world){ Q:<t(.40  0 1.789) d(-90 0 0 1)> shape:marker, size:[.1], focalLength:1., width:640, height:480, zRange:[.1 10] }
...
Edit L_panda_link0 (base) { Q:<t(0 .3 0)> }
...
frame endeffR (R_panda_hand_0) { Q:<t(0 0 .09) d(180 1 0 0) d(-90 0 0 1)> shape:marker size:[.1] color:[1 1 0] }
frame endeffL (L_panda_hand_0) { Q:<t(0 0 .09) d(180 1 0 0) d(-90 0 0 1)> shape:marker size:[.1] color:[1 1 0] }
