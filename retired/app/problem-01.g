...
body redBall { size=[.06 .06 .06 .02] color=[1 0 0] type=ssBox, contact, percept, logical={ object } }
...
shape stick(nostick) { type=9 size=[.8 .025 .04 .01] color=[.6 .3 0] contact, percept, logical={ object } }
