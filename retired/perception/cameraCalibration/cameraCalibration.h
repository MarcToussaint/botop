...
struct CameraCalibration {
  ...
  CameraCalibration();
  CameraCalibration(const rai::KinematicWorld& world, const char* calibrationVolumeFrameName, const char* calibrationMarkerName);
  ~CameraCalibration();
  ...
  void tuneHSVValues(const byteA& _rgb, const floatA& _depth);
};
